...
const CarCard = ({ name, brand, minprice, maxprice, image,_id }) => {
  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-md border border-[#E5E5E5] transition-transform hover:scale-105 w-full max-w-sm mx-auto">
      ...
      <div className="p-4 space-y-2">
        ...
        <button
          className="w-full bg-[#FCA311] text-black font-semibold py-2 rounded hover:bg-[#e59400] transition-colors"
