  ...
  return (
    <div className="px-6 py-4">
      ...
      <div className="flex flex-col lg:flex-row lg:gap-8">
        ...
        {/* Filter Sidebar */}
        <div className="w-full lg:w-80 lg:min-w-[20rem] lg:shrink-0 mb-8 lg:mb-0">
          <div className="bg-gradient-to-br from-white to-gray-50 shadow-xl rounded-2xl p-8 border border-gray-100 lg:sticky lg:top-6">
